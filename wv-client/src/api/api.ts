...
import { AuthResponse, ApiError, Transaction, GetTransactionsResponse, User, UpdateUserPayload } from 'types/types';
...
export default { ping, login, register, refreshToken, getTransactions, addTransaction, updateTransaction, deleteTransaction, getUser, updateUser };
